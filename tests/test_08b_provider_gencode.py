...
def test_get_genome_download_link(gencode):
    ...
    assert link in [
        ...
        "https://hgdownload-euro.soe.ucsc.edu/goldenPath/hg19/bigZips/chromFa.tar.gz",
        "https://hgdownload.soe.ucsc.edu/goldenPath/hg19/bigZips/hg19.fa.masked.gz",
        "https://hgdownload-euro.soe.ucsc.edu/goldenPath/hg19/bigZips/hg19.fa.masked.gz",
    ]
